...
const firebaseConfig = {
  ...
  storageBucket: import.meta.env.VITE_FIREBASE_STORAGE_BUCKET || "rpp-central-database.firebasestorage.app",
...
// Use explicit bucket URL for Firebase Storage to ensure correct bucket
